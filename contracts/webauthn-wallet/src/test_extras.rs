...
fn test_policy_policy() {
    ...
    let root_invocation = SorobanAuthorizedInvocation {
        function: SorobanAuthorizedFunction::ContractFn(InvokeContractArgs {
            ...
            args: std::vec![SignerKey::Policy(Policy(sample_policy_address.clone()))
            .try_into()
            .unwrap(),]
            .try_into()
            .unwrap(),
            ...
            args: std::vec![
                ...
                vec![
                    ...
                    Context::Contract(ContractContext {
                        ...
                        args: vec![
                            &env,
                            SignerKey::Policy(Policy(sample_policy_address.clone()))
                        ]
                        .into_val(&env),
                    })
                ]
    ...
    wallet_client
        ...
        .remove(&SignerKey::Policy(Policy(sample_policy_address.clone())));
    ////
}

#[test]
fn test_policy_signer() {
    let env = Env::default();
    let signature_expiration_ledger = env.ledger().sequence();
    ...
    wallet_client.mock_all_auths().add(&Signer::Ed25519(
        ...
        SignerStorage::Temporary,
        SignerType::Basic(vec![&env, Policy(sample_policy_address.clone())]),
    ));
    ////
