...
fn test() {
    ...
    // let example_contract_address = env.register_contract_wasm(None, ExampleContractWASM);
    ...
    // Policy
    // let sample_policy_address = env.register_contract_wasm(None, PolicyContractWASM);
