 ...
 * @default 102400
 */
const FEDERATION_RESPONSE_MAX_SIZE = exports.FEDERATION_RESPONSE_MAX_SIZE = 100 * 1024;
...
class FederationServer {
  ...
  static async createForDomain(domain, opts = {}) {
    const tomlObject = await _stellartoml.Resolver.resolve(domain, opts);
  ...
  async resolveAddress(address) {
    ...
    const url = this.serverURL.query({
      type: "name",
      q: stellarAddress
    });
